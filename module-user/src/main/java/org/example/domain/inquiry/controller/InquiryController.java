...
public class InquiryController {
  ...
  @PutMapping("/{inquiry-id}/public")
  @Operation(summary = "문의 공개 여부 변경")
  public ApiResponse<Void> updateInquiryPublic(@PathVariable("inquiry-id") long inquiryId) {
    inquiryService.updateInquiryPublic(inquiryId);
    return ApiResponse.onSuccess();
  }
